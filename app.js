...
class GPUComputationRenderer {
	...
	constructor( sizeX, sizeY, renderer ) {
		...
		let dataType = external_three_.FloatType;
		...
		this.createRenderTarget = function ( sizeXTexture, sizeYTexture, wrapS, wrapT, minFilter, magFilter ) {
			...
			wrapS = wrapS || external_three_.ClampToEdgeWrapping;
			wrapT = wrapT || external_three_.ClampToEdgeWrapping;

			minFilter = minFilter || external_three_.NearestFilter;
			magFilter = magFilter || external_three_.NearestFilter;

			const renderTarget = new external_three_.WebGLRenderTarget( sizeXTexture, sizeYTexture, {
				wrapS: wrapS,
				wrapT: wrapT,
				minFilter: minFilter,
				magFilter: magFilter,
		...
		this.createTexture = function () {
			...
			const texture = new external_three_.DataTexture( data, sizeX, sizeY, external_three_.RGBAFormat, external_three_.FloatType );
...
class WorldState {
    ...
    restart(options, texTemperature) {
        ...
        const varVelocity = gpu.addVariable("texVelocity", velocity_comp_namespaceObject, texVelocity);
        const varPosition = gpu.addVariable("texPosition", position_comp_namespaceObject, texPosition);
    ...
    tick() {
        ...
        this.renderState.particleUniforms["texPosition"].value =
            this.renderState.gpu.getCurrentRenderTarget(this.renderState.varPosition).texture;
        this.renderState.particleUniforms["texVelocity"].value =
            this.renderState.gpu.getCurrentRenderTarget(this.renderState.varVelocity).texture;
    }
...
/* harmony import */ var _simulator_simulator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(151);
